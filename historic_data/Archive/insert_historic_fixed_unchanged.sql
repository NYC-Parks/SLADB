...
begin transaction;
	...
	insert into sladb.dbo.tbl_unit_sla_season(unit_id,
											  ...
											  effective_from,
											  effective_to)
		select r2.obj_code as unit_id,
			   /*If an SLA was null before and after the review than the assumption is that it should be assigned the SLA value of 'N'*/
			   coalesce(r.sla_code, 16) as sla_code,
			   1 as season_id,
			   1 as effective,
			  case when r2.obj_commiss >= '2014-01-01' then cast(r2.obj_commiss as date)
		...
		inner join
			 ...
			 where obj_withdraw >= '2014-01-01' or
		...
		where ((r3.sla_code = r.sla_code) or
			   (r.sla_code is null and r3.sla_code is null))
commit;